...
class Musico_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Musico ] Social Links', 'musico-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'musico-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'musico-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'musico-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'musico-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'musico-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'musico-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'musico-companion'); ?></label>
...
} // Class musico_social_links ends here


// Register and load the widget
function musico_social_links_widget_load() {
	register_widget( 'Musico_social_links' );
}
add_action( 'widgets_init', 'musico_social_links_widget_load' );