...
----------------------------------------*/
class musico_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('musico_instagram_photo',esc_html__('[ Musico ] Intagram Photo','musico-companion'),array(
			'description' => esc_html__('Musico Instagram Photo Widget','musico-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'musico-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'musico-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'musico-companion'); ?></label>
...
if(!function_exists('musico_instagram_widgets')):
	function musico_instagram_widgets(){
		register_widget('musico_instagram_photo');
	}
	add_action('widgets_init','musico_instagram_widgets');
endif;
