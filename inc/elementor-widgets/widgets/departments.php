...
/**
 *
 * Musico elementor departments section widget.
 *
 * @since 1.0
 */
class Musico_Departments extends Widget_Base {

	public function get_name() {
		return 'musico-departments';
	}

	public function get_title() {
		return __( 'Departments', 'musico-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'musico-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'musico-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'musico-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'musico-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'musico-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'musico-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'musico-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                    ...
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                        'btn_text'   => __( 'Learn More', 'musico-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                        'btn_text'   => __( 'Learn More', 'musico-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                        'btn_text'   => __( 'Learn More', 'musico-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                        'btn_text'   => __( 'Learn More', 'musico-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'musico-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'musico-companion' ),
                        'btn_text'   => __( 'Learn More', 'musico-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'musico-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'musico-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'musico_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
