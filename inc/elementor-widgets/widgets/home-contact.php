...
/**
 *
 * Musico elementor home contact section widget.
 *
 * @since 1.0
 */
class Musico_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'musico-home-contact';
	}

	public function get_title() {
		return __( 'Home Contact', 'musico-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Contact Settings', 'musico-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Get Free Quote', 'musico-companion' ),
            ]
        );
        $this->add_control(
            'form_shortcode',
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Best size is 588x500', 'musico-companion' ),
    ...
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'musico_home_contact_588x500', '', array( 'alt' => 'right image' ) ) : '';
    ?>
