...
/**
 *
 * Musico elementor home appointment section widget.
 *
 * @since 1.0
 */
class Musico_Contact_Project extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact for Project', 'musico-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Contact for Project Settings', 'musico-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Let’s discuss for a project', 'musico-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            'btn_text',
            [
                'label' => esc_html__( 'Button Text', 'musico-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Start Talking', 'musico-companion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'musico-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'musico-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
