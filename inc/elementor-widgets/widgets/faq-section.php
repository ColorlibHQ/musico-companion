...
/**
 *
 * Musico elementor faq section section widget.
 *
 * @since 1.0
 */
class Musico_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'musico-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'musico-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'musico-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Faq Image', 'musico-companion' ),
                'description' => esc_html__( 'Best size is 490x480', 'musico-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'musico-companion' ),
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Faq Title', 'musico-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Frequently ask', 'musico-companion' )
            ]
        );
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'musico-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Adieus who direct esteem It esteems luckily?', 'musico-companion' ),
                    ],
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'musico-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem esteems luckily or picture placing drawing.', 'musico-companion' ),
                    ],
                ],
                'default'   => [
                    [      
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'musico-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'musico-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'musico-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'musico-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $sec_img = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'musico_accordion_thumb_490x480', '', array( 'alt' => $sec_title ) ) : '';
