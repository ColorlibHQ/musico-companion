(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".musico-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".musico-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".musico-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.musico-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.musico-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.musico-subscribe-newsletter-area');
    if ($subscribe.length) {
